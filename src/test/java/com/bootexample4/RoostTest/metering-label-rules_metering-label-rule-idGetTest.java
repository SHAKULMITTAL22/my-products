...
public class metering-label-rules_metering-label-rule-idGetTest {
    ...
    public void metering-label-rules_metering-label-rule-id_get_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/bootexample4/RoostTest/metering-label-rules_metering-label-rule-idGetTest.csv"))) {  
